    ...
    try:
        ...
        response = openrouter_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": f"Ты - эксперт в области разработки программного обеспечения и системного администрирования. Ты умеешь подробно и структурированно объяснять технические изменения, выделяя практическую ценность для пользователей и администраторов на {language}."
                },
                {
                    "role": "user",
                    "content": prompt
